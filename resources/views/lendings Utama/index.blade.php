@extends('layouts.app')
@section('title', 'Lendings_utama')
@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fa-solid fa-hand-holding-hand"></i> Lending</h2>
    <div>
...
<div class="card mb-4 border-0 p-3">
    <form action="{{ route('lendings_utama.index') }}" method="GET" id="filterForm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @endif
                    <form action="{{ route('lendings_utama.destroy', $l->id) }}" method="POST" class="d-inline" id="delete-form-{{ $l->id }}">
                        @csrf @method('DELETE')
