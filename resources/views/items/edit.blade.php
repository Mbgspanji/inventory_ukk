                ...
                <div class="row mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="total" class="form-control @error('total') is-invalid @enderror"
                            min="0" value="{{ old('total', $item->total) }}">
                        @error('total')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <small class="text-danger">Menambah antrian Repair, mengurangi Available.</small>
                        </div>

                        <div class="col-md-6">
                            <label class="text-success fw-bold">Fixed Items (Sudah Diperbaiki)</label>
                            <input type="number" name="fixed_items" class="form-control" min="0"
                                max="{{ $item->repair }}" value="0">
                            <small class="text-success">Mengurangi Repair, menambah Available.</small>
                        </div>
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-md-12">
                        <div class="alert alert-secondary">
                            ...
                            Available: {{ $item->available }} | Lending: {{ $item->lending_total }} | Repair:
                            {{ $item->repair }}
                        </div>
                    </div>
                </div>
